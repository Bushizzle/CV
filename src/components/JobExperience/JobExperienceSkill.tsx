...
import styles from './JobExperienceSkill.scss';

interface JobExperienceSkillProps {
    name: string;
}

export const JobExperienceSkill: FunctionComponent<JobExperienceSkillProps> = ({
    name,
 }) => {
    ...
    let ref = createRef();
    return (
        <li ref={ref} className={styles.skill} onClick={() => {
            showHint(true);
